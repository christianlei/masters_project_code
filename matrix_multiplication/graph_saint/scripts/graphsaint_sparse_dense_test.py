...
def sparse_dense_multiplication_universal(matrix1, matrix2, numba=False, output=True): # result_matrix, first_dimension, second_dimension,
...
#_________________________####_____###_____###_______________###________________________#
...
def sparse_dense_multiplication_timing(matrix1, matrix2):
    first_dimension = matrix1.get_shape()[0]
    second_dimension = len(matrix2[0])
    value = matrix1.data
    column_idx = matrix1.indices
...
def main():
    ...
    print("Outside time taken: ", end-start)

    print("UNIVERSAL")

    sparse_dense_multiplication_universal(sparse_array, dense_array)

    sparse_dense_multiplication_universal(sparse_array, dense_array, True, False)
    sparse_dense_multiplication_universal(sparse_array, dense_array, True, False)
